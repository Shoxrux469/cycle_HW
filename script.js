...
let other = []
users.forEach(links =>{
    if(links.email.slice(-3) === 'org') {
        emails.org.push(links.email)
    } else if (links.email.slice(-3) === 'net') {
        emails.net.push(links.email)
    } else if (links.email.slice(-4) === 'info') {
        emails.info.push(links.email)
    } else {
        other.push(links.email)
    }
})
